...
model1_path = os.path.join('Project1/pickle', 'model1.p')
with open(model1_path, 'rb') as fw:
    model = pickle.load(fw)
vectorizer_path = os.path.join('Project1/pickle', 'vectorizer.pk1')
...
rawCorpus_predictions_df.to_csv('Project1/results/rawCorpus_predictions.csv', index=False)
consolidated_df['predictions'] = predictions
full_path = os.path.join('Project1/results', 'toxicEval.csv')
